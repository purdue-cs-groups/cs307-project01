...
namespace WebService.Common
{
    public class InputValidator
    {
         ...
         */
        public static bool isValidLength(String str, int lower, int upper)
        {
        ...
        {
            //Checks to be sure email is not null
            if (email == null)
            {
                return false;
            }
         ...
         *      Special characters not allowed
         *      Spaces not allowed
         *      Between 4-25 characters in length
         */
        ...
        // Checks whether this string is not empty, returns true if not empty
