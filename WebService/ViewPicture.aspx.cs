...
namespace WebService
{
    public partial class ViewPicture : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            // tweet button
            this.litTweetButton.Text = "<a href=\"https://twitter.com/share?via=winstagram&text=" + picture.Caption + " " + Request.Url.AbsoluteUri + "\" class=\"twitter-share-button\" data-lang=\"en\">Tweet</a>\n";
