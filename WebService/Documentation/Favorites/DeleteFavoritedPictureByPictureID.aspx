<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteFavoritedPictureByPictureID.aspx.cs" Inherits="WebService.Documentation.Favorites.DeleteFavoritedPictureByPictureID" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Metrocam - /v1/favorites/deleteByPictureID?pictureid={pictureId}</title>
...
<body>
    ...
    <div class="layout">
        ...
        <br />
        <div class="endpoint">
            GET /v1/favorites/deleteByPictureID?pictureid={pictureId}<br />
            <br />
            <br />
            <div class="code">
                <i>Request: </i>
