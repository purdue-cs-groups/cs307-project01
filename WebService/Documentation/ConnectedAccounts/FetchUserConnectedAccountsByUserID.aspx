<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FetchUserConnectedAccountsByUserID.aspx.cs" Inherits="WebService.Documentation.ConnectedAccounts.FetchUserConnectedAccountsByUserID" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>Metrocam - /v1/users/connections/fetchByUserID?userid={userId}</title>
...
<body>
    ...
    <div class="layout">
        ...
        <br />
        <div class="endpoint">
            GET /v1/users/connections/fetchByUserID?userid={userId}<br />
            <br />
            <br />
            <div class="code">
                <i>Request: </i>
